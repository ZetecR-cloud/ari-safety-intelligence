    ...
    <div className="page">
      <div className="wrap">
        ...
        <div className="card">
          ...
          <div className="small">Validity / TEMPO / BECMG を視覚化（現段階はUI確認用）</div>
          <div className="timelineWrap">
            <TafTimeline tafRaw={tafRaw} />
          </div>
        </div>
